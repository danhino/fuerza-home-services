const es = {
    ...
    // ── Job Accepted ─────────────────────────────────
    'jobAccepted.title': 'Técnico En Camino',
    'jobAccepted.heading': '¡Tu técnico está en camino!',
    'jobAccepted.estimatedArrival': 'Llegada Estimada',
    'jobAccepted.reviews': 'reseñas',
    'jobAccepted.jobSummary': 'Resumen del Trabajo',
    'jobAccepted.serviceType': 'Tipo de Servicio',
    'jobAccepted.address': 'Dirección del Servicio',
    'jobAccepted.estimate': 'Presupuesto',
    'jobAccepted.problemLink': 'Hay un problema',
    'jobAccepted.message': 'Mensaje al Técnico',
    'jobAccepted.cancel': 'Cancelar Trabajo',
    'jobAccepted.cancelTitle': '¿Cancelar Solicitud?',
    'jobAccepted.cancelMsg': '¿Estás seguro de que quieres cancelar esta solicitud de servicio?',
    'jobAccepted.cancelError': 'Error al cancelar el trabajo',
